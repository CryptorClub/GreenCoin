...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04d45af83015fff9ac798252a0bb65fba395a9481f0d3bf9dc742f4f8c324b581aa1aa192ebe75ac5c97cb6fb242e4a5ebc9091c0a953942b24af9142b97f47711");
        nDefaultPort = 33099;
        nRPCPort = 33100;
        ...
        //
        // CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1518177048, nBits=1d00ffff, nNonce=0, vtx=1)
        //   CTransaction(hash=4a5e1e, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        //     CTxIn(COutPoint(000000, -1), coinbase 04ffff001d0104455468652054696d65732030332f4a616e2f32303039204368616e63656c6c6f72206f6e206272696e6b206f66207365636f6e64206261696c6f757420666f722062616e6b73)
        //     CTxOut(nValue=50.00000000, scriptPubKey=0x5F1DF16B2B704C8A578D0B)
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "PyeongChang 2018 Olympic Winter Games";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1518177048;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 2001971781;
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("043f699e9505772e44bd400e03c91e97bc51b5602e13661b0632e11bedba7a8dc0836162a47318050c33861226a9c61d647b5fc029e749f714f80cdd725565a422");
        nDefaultPort = 43099;
        nRPCPort = 43100;
        strDataDir = "testnet3";
